        ...
        {filteredEntries.length === 0 ? (
          ...
          filteredEntries.map((entry) => (
            <Link href={`/diary/${entry.id}`} key={entry.id}>
              <div
                className="relative diary-paper bg-white p-6 rounded-xl shadow-lg border-2 border-primary-100 before:content-[''] before:absolute before:left-0 before:top-0 before:bottom-0 before:w-2 before:bg-primary-200 before:rounded-l-lg"
              >
